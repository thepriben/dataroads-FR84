...
| Roadside areas & car-pooling | OpenStreetMap | twice-weekly cache (Mon & Thu) | 160 areas: car-pooling, rest areas, park-and-ride along departmental roads (issue #7), generated by `scripts/update_osm_geojson.py`. |

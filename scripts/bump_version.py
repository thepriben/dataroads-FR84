#!/usr/bin/env python3
"""Bump semver, sync js/config.js from VERSION, and verify CHANGELOG."""
...
def main() -> int:
    ...
    sync_parser = sub.add_parser("sync", help="Write VERSION into js/config.js")
